...
/**
 * DriftGrid request proxy — v1 simplified auth model:
 *
 ...
 *
 * Renamed from `middleware.ts` to `proxy.ts` for Next.js 16 — the middleware
 * file convention is deprecated. Exported function is `proxy` to match.
 */
...
export async function proxy(request: NextRequest) {
  // Next.js 16: this is the renamed middleware. The function name is meaningful.
