...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    hint: 'You direct, your agent executes. Columns are concepts, rows are versions. Press an arrow to look around.',
    keys: ['←', '→', '↑', '↓'],
    advanceOn: 'arrow',
  },
  {
    eyebrow: 'Open a design',
    hint: 'Press Enter or double-click any card to view the live HTML at full size.',
    keys: ['Enter', '2x click'],
    advanceOn: 'enter',
  },
  {
    eyebrow: 'Leave a prompt',
    hint: 'Press C, then click anywhere to drop a prompt. Your agent reads it and updates the design.',
    keys: ['C'],
    advanceOn: 'comment',
  },
  {
    eyebrow: 'Toggle the grid',
    hint: 'Press G to flip between the grid and a single design. Esc also returns to the grid.',
    keys: ['G', 'Esc'],
    advanceOn: 'esc',
  },
  {
    eyebrow: 'Drift up — new version',
    hint: 'Press D to create a new version of the current design. An empty slot appears above — drop a prompt to fill it.',
    keys: ['D'],
    advanceOn: 'drift',
  },
  {
    eyebrow: 'Drift right — new concept',
    hint: 'Press Shift+D to start a fresh concept — a whole new direction to explore. An empty column appears to the right.',
    keys: ['Shift', 'D'],
    advanceOn: 'branch',
  },
  {
    eyebrow: 'Keep drifting',
    hint: 'That\u2019s the loop \u2014 prompt, drift, compare. Press ? for the full shortcut list anytime.',
    keys: ['?'],
    advanceOn: 'any',
  },
];
